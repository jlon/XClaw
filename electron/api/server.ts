...
import { handleAgentMarketRoutes } from './routes/agent-market';
...
import { handleStudioRoutes } from './routes/studio';
...
export function startHostApiServer(ctx: HostApiContext, port = PORTS.XClaw_HOST_API): Server {
