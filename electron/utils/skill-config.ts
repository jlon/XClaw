...
import { getOpenClawConfigPath, getOpenClawDir, getOpenClawSkillsDir, getResourcesDir } from './paths';
...
/**
 * Built-in skills bundled with XClaw that should be pre-deployed to
