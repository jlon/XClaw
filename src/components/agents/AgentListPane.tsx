...
export function AgentListPane({
  ...
  return (
    <section
      className={cn(
        'flex h-full min-h-0 flex-col overflow-hidden rounded-[24px] border border-border/60 bg-[hsl(var(--surface-elevated)/0.98)] text-foreground shadow-[0_18px_50px_rgba(15,23,42,0.04)]',
        className,
      )}
    >
        ...
        <div className="flex items-center gap-2.5">
          ...
          {onCreateAgent ? (
            <Button
              ...
              className="h-10 shrink-0 rounded-[15px] border-border/65 bg-[hsl(var(--surface-panel)/0.96)] px-3.5 text-[13px] font-medium text-foreground/76 shadow-[inset_0_1px_0_rgba(255,255,255,0.4)] transition-colors hover:bg-[hsl(var(--surface-hover)/0.55)] hover:text-foreground"
            >
