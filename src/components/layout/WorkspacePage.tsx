...
export function WorkspacePageShell({
  ...
  return (
    <div className={cn('workspace-page-shell desktop-workspace-shell flex h-full w-full flex-col rounded-none border-0 bg-transparent px-4 py-4 md:px-6 shadow-none', className)} {...props}>
      {children}
    </div>
  );
}
