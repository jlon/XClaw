  ...
  return (
    ...
    >
      ...
      {mode === 'takeover' && status?.error ? (
        <motion.div variants={setupStageItemVariants} className="rounded-xl border border-red-500/20 bg-[hsl(var(--danger)/0.08)] p-4 text-sm leading-6 text-destructive">
          {status.error}
        </motion.div>
      ) : null}
