...
const badgeVariants = cva(
  'inline-flex items-center rounded px-1.5 py-0.5 text-xs font-semibold tracking-wide transition-colors focus:outline-none focus:ring-2 focus:ring-ring/30 focus:ring-offset-2 focus:ring-offset-background select-none',
  {
    variants: {
      variant: {
        default:
