  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-40 flex items-start justify-center px-6 pt-6">
      <div className="pointer-events-auto w-full max-w-[44rem] rounded-xl border border-border/70 bg-background p-5 shadow-xl">
        ...
        <div className="mt-4 rounded-xl border border-[hsl(var(--border)/0.82)] bg-[hsl(var(--surface-panel)/0.92)] px-4 py-3 shadow-sm">
        ...
        <div className="mt-4 grid gap-2 text-sm text-[hsl(var(--muted-foreground))] md:grid-cols-3">
          <div className="rounded-lg border border-[hsl(var(--border)/0.72)] bg-[hsl(var(--background)/0.72)] px-3 py-2">
        ...
        {error ? (
          <div className="mt-4 rounded-lg border border-[hsl(var(--danger)/0.22)] bg-[hsl(var(--danger)/0.1)] px-4 py-3 text-sm text-destructive">
            {error}
          </div>
        ) : null}
        ...
        <div className="mt-5 flex flex-wrap items-center justify-end gap-2">
          <Button
            ...
            variant="outline"
            disabled={busy}
            className="h-9 rounded-md border-[hsl(var(--danger)/0.24)] bg-[hsl(var(--danger)/0.08)] px-4 text-destructive hover:bg-[hsl(var(--danger)/0.12)]"
          ...
          <Button
            ...
            variant="outline"
            disabled={busy}
            className="h-9 rounded-md border-[hsl(var(--border)/0.8)] bg-[hsl(var(--surface-elevated)/0.98)] px-4 hover:bg-[hsl(var(--surface-hover)/0.7)]"
          ...
          <Button
            type="button"
            disabled={busy}
            className="h-9 rounded-md bg-primary px-5 text-primary-foreground shadow-sm hover:bg-primary/92"
