        ...
        {groups.map((group) => {
          ...
          const content = (
            <>
              ...
              <svg viewBox="0 0 100 4" className="mt-1.5 h-1 w-full overflow-visible" preserveAspectRatio="none">
                <rect x="0" y="0" width="100" height="4" rx="2" fill="hsl(var(--surface-hover) / 0.74)" />
                <rect
                  x="0"
                  y="0"
                  width={width}
