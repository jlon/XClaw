...
interface ChatState {
  ...
  toggleThinking: () => void;
  setSessionModel: (model: string | null) => Promise<string | undefined>;
...
const IMAGE_CACHE_KEY = 'XClaw:image-cache';
...
function ensureSessionEntryModel(
  ...
  return [...sessions, { key: sessionKey, displayName: sessionKey, model }];
}
